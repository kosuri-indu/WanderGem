...
final layoverProvider =
    StateNotifierProvider<LayoverNotifier, List<String>>((ref) {
  return LayoverNotifier();
});

class LayoverNotifier extends StateNotifier<List<String>> {
  late GenerativeModel _model;
  late ChatSession _chatSession;

  LayoverNotifier() : super([]) {
    _initializeGemini();
  }
